...
public class MyDate implements Cloneable {
    ...
    public void setDay(int day) { setDate(day, month, year); }
    public void setMonth(int month) { setDate(day, month, year); }
    public void setYear(int year) { setDate(day, month, year); }
